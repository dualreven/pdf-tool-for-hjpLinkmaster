...
const PDFViewerApplication = {
    ...
    if (params.get("disableworker") === "true") {
      try {
        ...
        if (typeof PDFJSDev === "undefined") {
          globalThis.pdfjsWorker = await import("./src/pdf.worker.js");
        } else {
  ...
  downloadOrSave(options = {}) {
    ...
    this.eventBus.dispatch(CONSTANTS.eventName.PDF_SAVE_START,{filename})
    options.callback = (msg)=>{
      if(msg==="ok"){
        this.eventBus.dispatch(CONSTANTS.eventName.PDF_SAVE_COMPLETED,{filename,msg})
      }
      else{
        this.eventBus.dispatch(CONSTANTS.eventName.PDF_SAVE_FAILED,{filename,msg})
      }
    }
